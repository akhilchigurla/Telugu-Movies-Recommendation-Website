...
import { Mail, Lock, UserPlus, AlertCircle, Film, Check } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center px-4 pt-16">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2">Join TeluguReel and discover great Telugu cinema</p>
        </div>
        ...
        <div className="bg-zinc-900/80 backdrop-blur-lg border border-white/10 rounded-2xl p-8">
          ...
          {success ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-400 mb-6">You can now sign in with your credentials.</p>
              <Link
                to="/login"
